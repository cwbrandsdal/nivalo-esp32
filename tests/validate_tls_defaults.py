...
def main() -> None:
    ...
    external_configs = [
        WORKSPACE / "nivalo-examples" / "esp32-standalone" / "include" / "nivalo_config.example.h",
        WORKSPACE / "nivalo-examples" / "esp32-stm32-bridge" / "include" / "nivalo_config.example.h",
    ]
